...
var Arknights = {
	...
	F_BG_PARRALAX_INI: function () {
		...
		Arknights._coverData = cover;

		$('#mark').height($(window).height());
		Arknights._resizeBg(cover);

		var scene = document.getElementById('mark');
		var parallaxInstance = new Parallax(scene);
	},
	_resizeBg: function (cover) {
		if (!cover) cover = Arknights._coverData;
		if (!cover) return;
